...
```javascript
import lossFunctions from 'https://cdn.jsdelivr.net/gh/stdlib-js/ml-base-sgd-loss-functions@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { enum } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ml-base-sgd-loss-functions@esm/index.mjs';
```
